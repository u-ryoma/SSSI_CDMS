...
//       if (
//         assetNo &&
//         !s.assetNo?.toLowerCase().includes(assetNo.toLowerCase())
//       )
//         return false;
...
//   const selectedStandard = filteredStandards.find(
//     (s) => s.id === selectedId,
//   );
...
//                       key={s.id}
//                       className={
//                         s.id === selectedId ? "csl-row-selected" : ""
//                       }
...
//                 No calibration standards to show yet — connect this modal
//                 to your standards list.
//               </div>
//             )}
//           </div>
...
//                 Use Standard
//               </button>
//               <button type="button" className="csl-cancel-btn" onClick={onCancel}>
//                 Cancel
//               </button>
//             </div>
//           </div>
