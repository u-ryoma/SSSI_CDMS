...
//   // there. Shows completed jobs for that customer only — meaning jobs
//   // that finished Print Final (forDeliveryTagged === true) and haven't
//   // already been used in a prior delivery receipt (delivered !== true).
//   //
//   // TODO: "Log" and "Quick Log" are still stubbed - no reference yet for
//   // what those screens should show.
...
//     // Reload automatically whenever a different customer is picked while
//     // this modal is open, so stale rows from a previous customer never
//     // show up.
//     useEffect(() => {
//       if (isOpen) {
//         handleLoad();
