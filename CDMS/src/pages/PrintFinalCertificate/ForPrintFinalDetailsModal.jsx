...
//                 {/* OIC — the assigned OIC from Incoming/On-Going
//                     Calibration (oicBy), NOT evalBy (CPGP/SSSI, a
//                     separate field set back in JobNumberModal and
//                     unrelated to who processed this job). */}
//                 <label>OIC</label>
...
const ForPrintFinalDetailsModal = ({
  ...
  // ForCheckingSig / JobNumber. onOpenFolder (if passed in) still fires
  // first, in case the parent screen needs to do something of its own
  // (e.g. logging/analytics) — but showing the modal no longer depends
  // on the parent actually doing anything with it.
